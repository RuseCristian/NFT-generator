...
for i in range(0,20):
    ...
    eye_dir   = base_dir + '/eyes/eyes_'     + str(eye_no)    + '.png'
    mouth_dir = base_dir + '/mouths/mouth_'  + str(mouth_no)  + '.png'
    wig_dir   = base_dir + '/wigs/wig_'      + str(wig_no)    + '.png'
    beard_dir = base_dir + '/beards/beard_'  + str(beard_no)  + '.png'
    nose_dir  = base_dir + '/noses/nose_'    + str(nose_no)   + '.png'
    hat_dir   = base_dir + '/hats/hat_'      + str(hat_no)    + '.png'
    glass_dir = base_dir + '/glasses/glass_' + str(glass_no)  + '.png'
